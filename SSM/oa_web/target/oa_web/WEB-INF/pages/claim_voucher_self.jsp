                        ...
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default light">
                                    <i class="fa fa-refresh" onclick="javascript:window.location.href='${pageContext.request.contextPath}/claim_voucher/self';"></i>
                                </button>
                                <button type="button" class="btn btn-default light">
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="message-unread">
                            ...
                            <td><a href="${pageContext.request.contextPath}/claim_voucher/to_delete?id=${cv.rep_id}">删除</a>
